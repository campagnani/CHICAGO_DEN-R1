...
class ChigagoDenR1:
    ...
    def tallies(self,):
        ...
        if self.fonte:
            ...
            plt.plot(fluxo_axial_comb_thermal, fluxo_z_comb_thermal, color='xkcd:red', linestyle='--',  linewidth=linewidth, label='Fuel - Thermal')
            plt.plot(fluxo_axial_comb_fast, fluxo_z_comb_fast, color='xkcd:royal blue', linestyle='--',  linewidth=linewidth, label='Fuel - Fast')
