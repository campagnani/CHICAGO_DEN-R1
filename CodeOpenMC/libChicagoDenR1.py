...
class ChigagoDenR1:
    ...
    def geometriaAgua(self):
        ...
        anel_font_mod_0  = [self.universo_agua]  # [self.universo_fonte] ou [self.universo_agua] para substituir a vareta central
        ...
        ############ Exportar Geometrias
        self.geometria_agua = openmc.Geometry([self.celula_outer])
        self.geometria_agua.export_to_xml()

    def geometriaFonte(self):
        print("################################################")
        print("############ Definição da Geometria ############")
        print("################################################")
        ...
        anel_comb_mod_2  = [self.universo_vareta_combustível]*12
        anel_comb_mod_1  = [self.universo_vareta_combustível]*6
        anel_font_mod_0  = [self.universo_fonte]  # [self.universo_fonte] ou [self.universo_agua] para substituir a vareta central
    ...
    def plot2D_secao_transversal_agua(self,basis="xz",width=[200,200],pixels=[20000,20000],origin=(0,0,0)):
        ...
        secao_transversal_agua = openmc.Plot.from_geometry(self.geometria_agua)
        ...
        secao_transversal_agua.color_by = 'material'
        secao_transversal_agua.colors = self.colors
        ############ Exportar Plots e Plotar
        plotagem = openmc.Plots((secao_transversal_agua,))
        plotagem.export_to_xml()  
        openmc.plot_geometry()

    def plot3D_agua(self):
        print("################################################")
        print("############        Plot 3D         ############")
        print("################################################")
        ############ Plotar em 3D
        plot_3d_agua = openmc.Plot.from_geometry(self.geometria_agua)
        plot_3d_agua.type = 'voxel'
        plot_3d_agua.filename = 'plot_voxel'
    ...
    def plot2D_secao_transversal_fonte(self,basis="xz",width=[200,200],pixels=[20000,20000],origin=(0,0,0)):
        ...
        print("################################################")
        ############ Plotar Secão Transversal
        secao_transversal_fonte = openmc.Plot.from_geometry(self.geometria_fonte)
    ...
    def plot3D_fonte(self):
        print("################################################")
        print("############        Plot 3D         ############")
        print("################################################")
        ############ Plotar em 3D
        plot_3d_fonte = openmc.Plot.from_geometry(self.geometria_fonte)
