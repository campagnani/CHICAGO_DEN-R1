...
class ChigagoDenR1:
    ...
    def geometriaPadrao(self, altura_fonte = 0):
        ...
        self.celula_combustivel = openmc.Cell(fill=self.ar, region=+plano_clad_comb_1&-plano_clad_comb_2&+cilindro_raio_interno_combustivel&-cilindro_raio_externo_combustivel
